        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative">
            <div className="aspect-square rounded-2xl overflow-hidden bg-linear-to-br from-blue-100 to-cyan-100">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-linear-to-br from-blue-500 to-cyan-500">
                <span className="text-white text-6xl font-bold">HSK</span>
              </div>
            </div>
